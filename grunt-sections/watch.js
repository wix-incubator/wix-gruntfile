...
module.exports = function (grunt, options) {
  return {
    ...
    replace: {
      files: ['app/**/*.vm'],
      tasks: ['replace:dist', 'inlineServeIfEnabled', 'copy:vm']
    },
    replaceConf: {
    ...
    compass: {
      ...
      tasks: ['scssstyleIfEnabled', 'compass:server', 'autoprefixerIfEnabled', 'replace', 'inlineServeIfEnabled', 'copy:vm']
    },
    styles: {
      files: ['app/{styles,modules}/**/*.css'],
      tasks: ['newer:copy:styles', 'inlineServeIfEnabled', 'autoprefixerIfEnabled']
    },
    gruntfile: {
      files: ['Gruntfile.js']
    },
